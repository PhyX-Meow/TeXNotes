...
#let lr(body) = math.lr("("+body+")", size:auto)
#let biglr(body) = math.lr(body, size:auto)
...
#proof[
  ...
  $ has dimension at least $floor(n/2)$, including $biglr(pdv(f,z)|)_p$. Thus $cal(V)$ contains a linear 
